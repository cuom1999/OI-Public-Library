...
| ---: | --- | ---: | --- | --- | --- |
| 1 | `sources/ioi/2013-national-training-team-collection.tex` | 137 | ToC plus first four articles translated | ToC is readable; body required OCR due mojibake text layer | Continue OCR-backed translation from article 5 onward. |
| 2 | `sources/ioi/2014-national-training-team-collection.tex` | 228 | ToC plus first four articles translated | ToC is readable; body required OCR due mojibake text layer | Continue OCR-backed translation from article 5 onward. |
| 3 | `sources/ioi/2016-national-training-team-collection.tex` | 234 | ToC plus first four articles translated | ToC is readable; body required OCR due mojibake text layer | Continue OCR-backed translation from article 5 onward. |
| 4 | `sources/ioi/2015-national-training-team-collection.tex` | 291 | ToC plus first four articles translated | `pdftotext` is mojibake even near the ToC; OCR works with visual checks | Continue OCR-backed translation from article 5 onward. |
| 5 | `sources/ioi/2023-national-training-team-collection.tex` | 249 | ToC plus first seven articles translated | `pdftotext` extracts readable Unicode Chinese | Continue from article 8 onward. |
