...
| 7 | `sources/ioi/2014-national-training-team-collection.tex` | 228 | Cover/ToC/topic note only | ToC is readable; body quality needs per-article check/OCR | Translate article by article with OCR fallback where needed. |
