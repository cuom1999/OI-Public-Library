...
| ---: | --- | ---: | --- | --- | --- |
| 1 | `sources/ioi/2022-national-training-team-collection.tex` | 246 | ToC plus first eight articles translated | `pdftotext` is essentially blank; Tesseract OCR is readable but noisy | Continue OCR-backed translation from article 9 onward. |
| 2 | `sources/ioi/2018-national-training-team-collection.tex` | 210 | ToC plus first eight articles translated | `pdftotext` extracts readable Unicode Chinese | Continue from article 9 onward; no OCR needed for first pass. |
| 3 | `sources/ioi/2020-national-training-team-collection.tex` | 196 | ToC plus first eight articles translated | `pdftotext` extracts readable Unicode Chinese | Continue from article 9 onward. |
| 4 | `sources/ioi/2017-national-training-team-collection.tex` | 204 | ToC plus first eight articles translated | `pdftotext` extracts readable Unicode Chinese | Continue from article 9 onward. |
| 5 | `sources/ioi/2019-national-training-team-collection.tex` | 231 | ToC plus first eight articles translated | `pdftotext` extracts body text but includes watermark noise | Continue from article 9 onward after filtering watermark text. |
