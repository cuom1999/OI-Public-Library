...
| ---: | --- | ---: | --- | --- | --- |
| 1 | `sources/ioi/2024-national-training-team-collection.tex` | 424 | ToC plus first seven articles translated | Body text layer is noisy; OCR works but formulas need visual checks | Continue from article 8 onward with OCR-backed article translations. |
| 2 | `sources/ioi/2025-national-training-team-collection.tex` | 168 | ToC plus first seven articles translated | `pdftotext` is readable but two-up layout interleaves pages | Continue from article 8 onward, splitting/cropping pages where needed. |
