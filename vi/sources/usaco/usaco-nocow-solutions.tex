...
\title{Lời giải USACO theo NOCOW}
\author{}
\date{}
...
\sourcepath{USACO / USACO solution notes, NOCOW edition, 47 pages}

\paragraph{Ghi chú về nguồn.}
Nguồn là một tuyển tập lời giải cộng đồng, gom nhiều cách làm, nhận xét về
độ mạnh của dữ liệu, và tham chiếu tới các chương trình Pascal/C/C++ đi kèm.
Bản dịch này đi theo thứ tự các bài trong tài liệu gốc, giữ lại thuật toán
chính, các biến thể đáng chú ý và các cảnh báo cài đặt quan trọng. Những đoạn
chỉ trỏ tới mã nguồn hoặc bình luận về đoạn mã mẫu được diễn giải ở mức ý
tưởng theo ngoại lệ code-template của dự án, thay vì chép lại toàn bộ mã.
