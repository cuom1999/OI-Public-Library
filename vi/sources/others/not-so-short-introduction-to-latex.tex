...
\TeX\ là một chương trình dàn trang do Donald E. Knuth tạo ra. Tên của nó được
phát âm gần như ``tech'', với âm cuối giống chữ cái Hy Lạp chi. Knuth thiết kế
\TeX\ để dàn những cuốn sách có công thức toán đẹp và chính xác, sau khi ông
không hài lòng với chất lượng in ấn của các bản thảo toán học thời đó.
...
\LaTeX\ là một tập hợp macro đặt trên \TeX, ban đầu do Leslie Lamport phát
triển. Nếu \TeX\ là động cơ, \LaTeX\ là bộ điều khiển giúp tác giả nói ở mức
cao hơn: đây là tiêu đề, đây là mục, đây là định lý, đây là tài liệu tham
khảo. Người viết không cần tự tính mọi khoảng trắng, cỡ chữ và vị trí dòng.

Phiên bản được dùng rộng rãi hiện nay là \LaTeXe. Tên này nhấn mạnh rằng nó là
thế hệ thứ hai của \LaTeX\ chuẩn, thống nhất nhiều cải tiến từng tồn tại rời
rạc trong các biến thể cũ.
...
\LaTeX\ có nhiều ưu điểm:
\begin{itemize}
  \item chất lượng dàn công thức toán rất cao;
  \item đánh số chương, mục, hình, bảng, định lý và phương trình tự động;
  \item tham chiếu chéo và mục lục được tạo từ cấu trúc tài liệu;
  \item tài liệu lớn có thể chia thành nhiều tập tin;
  \item văn bản nguồn là chữ thuần, dễ lưu phiên bản bằng hệ thống quản lý mã;
  \item nhiều gói mở rộng xử lý thư mục, chỉ mục, đồ họa, ngôn ngữ và phông chữ.
\end{itemize}

Giới hạn chính là đường cong học tập. Những việc trông rất trực quan trong
trình soạn thảo tương tác có thể cần một lệnh hoặc một gói trong \LaTeX. Ngoài
ra, nếu cố ép \LaTeX\ làm bố cục lạ bằng nhiều chỉnh sửa cục bộ, tài liệu có
thể trở nên khó bảo trì.
...
landscape & xoay trang nằm ngang;\\
...
.idx, .ind & dữ liệu chỉ mục và chỉ mục đã xử lý.
\end{tabular}
\end{center}
