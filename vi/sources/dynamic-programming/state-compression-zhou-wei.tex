...
hàng đang xét; bảng bảy dạng phủ trong nguồn liệt kê các khả năng có thể xảy
ra. Khi \(m=9\), DFS sinh \(79248\) cách phủ, nên với \(n=m=9\) độ phức tạp
...
toàn bộ phần văn bản có trong PDF, phục dựng hai hình nhúng trong PDF,
