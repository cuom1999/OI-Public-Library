...
\begin{tikzpicture}[x=.42cm,y=.42cm]
  ...
  \end{scope}
\end{tikzpicture}
\caption{Ba cách tạo trạng thái \(01101_2\) trong hình nguồn. Ô đỏ là quân xe của hàng hiện tại; hai màu còn lại biểu diễn hai thứ tự của hai hàng trước.}
\end{figure}
...
\end{tikzpicture}
\caption{Hình nguồn cho bài Bugs Integrated: màu vàng là vùng đã đầy trong \(s_2\), màu xanh là vùng điền vào \(s_1\), màu đỏ là ô ảo \(1\times1\).}
\end{figure}
