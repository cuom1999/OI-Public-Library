...
\origtitle{First look at digit-based counting problems}
\sourcepath{Dynamic Programming / Introductory digit DP.pdf}

\begin{abstract}
Tài liệu nguồn là một bộ slide ngắn về các bài toán đếm theo chữ số. Bản
dịch chuyển nội dung thành ghi chú liền mạch: trước hết thống nhất ký hiệu
khoảng, sau đó trình bày cách tiền xử lý trạng thái theo số chữ số và cách
quét từng chữ số của cận trên để tính số lượng trong một khoảng.
\end{abstract}
...
\begin{itemize}
  \item Lưu Thông, ``Bàn về các bài toán thống kê theo chữ số'', trong tuyển
