...
\begin{abstract}
Nguồn là một bộ slide PowerPoint về tối ưu hóa quy hoạch động. Bản tiếng Việt
này chuyển phần nội dung thuật toán thành một ghi chú có cấu trúc, giữ thứ tự
ví dụ của slide và các ý tưởng chính về giảm số trạng thái, giảm chi phí
chuyển trạng thái, cấu trúc dữ liệu, hàng đợi đơn điệu và tính đơn điệu của
quyết định.
\end{abstract}
...
\end{itemize}
Slide gốc nêu WC2007 \emph{Racing} như ví dụ cho hướng giảm số trạng thái,
rồi tập trung vào hướng thứ hai qua các ví dụ: dãy con tăng dài nhất, ZJU 2672
\emph{Fibonacci Subsequence}, SGU 183 \emph{Painting the Balls}, USACO DEC04
\emph{Divide}, bài toán gộp đá, SPOJ 108 \emph{Morse Code} và NOI 2005
\emph{Valse Brillante} (\texttt{adv1900}). Hai ví dụ cuối chỉ xuất hiện trong
danh sách mở đầu của slide; các phần chi tiết phía sau minh họa chủ yếu bằng
truy vấn cực trị, cấu trúc đơn điệu, hàng đợi đơn điệu và tính đơn điệu của
quyết định.

\section{Giảm số trạng thái}

Hướng đầu tiên là đổi mô hình để số trạng thái cần tính nhỏ hơn. Slide chỉ nêu
WC2007 \emph{Racing} như một đại diện: nếu mô hình trực tiếp phải lưu quá
nhiều thông tin lịch sử hoặc quá nhiều cấu hình tương đương, ta cần nhận ra
những thông tin nào thật sự ảnh hưởng đến các quyết định còn lại rồi gộp các
trạng thái tương đương. Đây là một kiểu tối ưu khác với các phần sau: ta không
chỉ làm phép chuyển nhanh hơn, mà làm cho không gian trạng thái nhỏ đi ngay từ
đầu.
...
N & \multicolumn{10}{c}{10}\\
A & 1&1&3&-1&2&0&5&-1&-1&8
\end{array}
\]
...
Một hình minh họa trong slide có thể đọc như sau: các đoạn được đánh số
$1,2,3$ nằm trên trục $0,\ldots,8$, còn hai khoảng $c_2,c_1$ mô tả hai vòi
phun đang xét.
\[
\begin{array}{c}
\texttt{        |-----c2----|-c1|}\\
...
\section{Các ví dụ chỉ được nêu tên trong slide}

Ngoài những ví dụ được triển khai chi tiết, slide mở đầu còn liệt kê SPOJ 108
\emph{Morse Code} và NOI 2005 \emph{Valse Brillante} (\texttt{adv1900}) trong
nhóm bài có thể tối ưu phép chuyển trạng thái. Slide gốc không đưa thêm phát
biểu bài toán, công thức hay hình minh họa cho hai mục này, vì vậy bản dịch
chỉ ghi lại vai trò của chúng trong danh sách ví dụ thay vì suy diễn thêm lời
giải.
