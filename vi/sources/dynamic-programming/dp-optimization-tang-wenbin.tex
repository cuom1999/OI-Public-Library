...
này chuyển phần nội dung thuật toán thành ghi chú đồng hành, giữ các ví dụ và
ý tưởng chính về giảm chi phí chuyển trạng thái, cấu trúc dữ liệu, hàng đợi
đơn điệu và tính đơn điệu của quyết định.
\end{abstract}
