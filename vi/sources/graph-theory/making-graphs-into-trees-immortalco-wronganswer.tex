...
Hình ví dụ có trọng số trong nguồn minh họa đúng quy tắc này: trên cây
tròn-vuông đã gán trọng số, cạnh tròn--tròn giữ trọng số gốc, cạnh nối đỉnh
...
Trong hình nguồn với tập điểm quan trọng \(\{2,8\}\), virtual tree trực tiếp
trên cây tròn-vuông sẽ đi qua các đỉnh vuông trung gian; sau khi chèn các đỉnh
tròn biểu diễn điểm rời khỏi chu trình, ta thu được một virtual cây
tròn-vuông hợp lệ. Đây là ví dụ hình học cho lý do phải chèn thêm đỉnh tròn
trên cạnh ảo xuất phát từ đỉnh vuông.
