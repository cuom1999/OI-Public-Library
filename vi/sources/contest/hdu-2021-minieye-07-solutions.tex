...
tròn. Dựng tam giác tương ứng như hình dưới đây, rồi dùng định lý cos để tìm
góc nâng $\theta$ mà lựu đạn có thể nổ trúng người.

\begin{center}
\begin{tikzpicture}[x=.65cm,y=.65cm,line cap=round,line join=round,font=\small]
  \begin{scope}
    \draw[gray!25,step=1] (-3.2,-2.8) grid (3.2,4.8);
    \draw[green!55!black,very thick] (0,0) circle (2.4);
    \draw[blue!65!black,very thick] (0,3.2) circle (1.1);
    \fill[blue!65!black] (0,0) circle (2pt) node[left] {$E$};
    \fill[blue!65!black] (0,3.2) circle (2pt);
    \draw[->,thick] (0,0) -- (2.45,1.05) node[midway,below right] {$v_0t$};
    \draw[->,thick] (0,3.2) -- (1.05,3.65) node[midway,above] {$r$};
    \draw[thick] (0,0) -- (0,3.2) node[midway,right] {$\frac12gt^2$};
    \node[align=center] at (0,-3.25) {đường tròn vị trí và\\miền nổ trúng};
  \end{scope}
  \begin{scope}[xshift=6.9cm]
    \coordinate (A) at (0,0);
    \coordinate (B) at (0,3.0);
    \coordinate (C) at (2.25,2.55);
    \draw[very thick] (A) -- (B) -- (C) -- cycle;
    \node[left] at ($(A)!0.52!(B)$) {$\frac12gt^2$};
    \node[right] at ($(A)!0.55!(C)$) {$v_0t$};
    \node[above] at ($(B)!0.55!(C)$) {$r$};
    \draw (0,.55) arc[start angle=90,end angle=49,radius=.55];
    \node at (.35,.72) {$\theta$};
    \node[align=center] at (1.05,-3.25) {tam giác dùng\\định lý cos};
  \end{scope}
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[x=.8cm,y=.8cm,line cap=round,line join=round,font=\small]
  \begin{scope}
    \draw[very thick] (-2,.2) -- (-.6,1.3) -- (.25,1.55) -- (2.1,.75) -- (2.4,-1.45);
    \draw[very thick] (-1.25,-1.2) -- (-.25,.85) -- (1.15,.45) -- (1.55,-.35);
    \foreach \p in {(-1.25,-1.2),(-.25,.85),(1.15,.45),(1.55,-.35),(-.6,1.3),(.25,1.55),(2.1,.75)}
      \fill[blue!65!black] \p circle (2pt);
    \node[fill=white,inner sep=1pt] at (.95,1.42) {bao lồi ngoài};
    \node[fill=white,inner sep=1pt] at (.25,.15) {bao lồi trong};
    \node at (0,-2.05) {cạnh gần nhất song song};
  \end{scope}
  \begin{scope}[xshift=6.2cm]
    \draw[very thick] (-2,.1) -- (-.85,1.45) -- (.35,2.15) -- (2.25,.9) -- (2.55,-1.25);
    \draw[very thick] (-1.45,-1.1) -- (-1.1,.65) -- (.85,.95) -- (1.65,.3) -- (1.85,-.65);
    \foreach \p in {(-1.45,-1.1),(-1.1,.65),(.85,.95),(1.65,.3),(1.85,-.65),(-.85,1.45),(.35,2.15),(2.25,.9)}
      \fill[blue!65!black] \p circle (2pt);
    \node[fill=white,inner sep=1pt] at (1.25,1.9) {bao lồi ngoài};
    \node[fill=white,inner sep=1pt] at (.15,.55) {bao lồi trong};
    \node at (0,-2.05) {cạnh gần nhất không song song};
  \end{scope}
\end{tikzpicture}
\end{center}
