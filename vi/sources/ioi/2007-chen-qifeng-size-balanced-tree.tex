...
\textit{Mô tả hình 1.1.} Phép \textsc{Left-Rotate}$(x)$ biến cấu hình hai nút
ở bên phải hình gốc thành cấu hình ở bên trái hình gốc bằng cách thay đổi một
số hằng định con trỏ. Cấu hình bên trái có thể được biến ngược lại thành cấu
hình bên phải bằng thao tác nghịch đảo, \textsc{Right-Rotate}$(y)$.
...
\textit{Mô tả hình 2.1.} Các nút $L$ và $R$ lần lượt là con trái và con phải
của nút $T$. Các cây con $A,B$ lần lượt là cây con trái và phải của $L$; các
cây con $C,D$ lần lượt là cây con trái và phải của $R$. Tương ứng với hai
tính chất (a) và (b), ta có
\[
  s[A],s[B]\le s[R],
  \qquad
  s[C],s[D]\le s[L].
...
\begin{enumerate}
  ...
  \item \textit{Mô tả hình 3.1.} Các nút và cây con được ký hiệu như trong
  hình 2.1, nhưng sau phép quay phải, $L$ trở thành gốc của phần cây đang xét,
  còn $T$ trở thành con phải của $L$.
...
\textit{Mô tả hình 3.2.} Ký hiệu giống hình 2.1, ngoại trừ có thêm các cây con
$E,F$ của nút $B$, trong đó $B$ là con phải của $L$.

\begin{enumerate}
  \item Trước hết thực hiện \textsc{Left-Rotate}$(L)$. Sau thao tác này, cấu
  hình hình 3.2 được biến thành cấu hình hình 3.3.
  \item \textit{Mô tả hình 3.3.} Các nút được ký hiệu như hình 3.2; sau phép
  quay trái tại $L$, nút $B$ nằm phía trên $L$ trong cây con trái của $T$.
  \item Tiếp theo thực hiện \textsc{Right-Rotate}$(T)$. Thao tác này biến hình
  3.3 thành hình 3.4.
  \item \textit{Mô tả hình 3.4.} Nút $B$ trở thành gốc của phần cây đang xét,
  $L$ là con trái của $B$, $T$ là con phải của $B$; các cây con $A,E,F,R$ gắn
...
\textit{Mô tả biểu đồ 1.} Chèn $2\,000\,000$ nút với giá trị ngẫu nhiên. Thời
gian chạy, tính bằng giây: SBT $7.13$, AVL $8.34$, Treap $11.36$, Randomized
BST $13.61$.

\textit{Mô tả biểu đồ 2.} Thực hiện $2\,000\,000$ thao tác với giá trị ngẫu
nhiên, gồm $66\%$ chèn và $33\%$ xóa. Thời gian chạy, tính bằng giây: SBT
$5.59$, AVL $7.42$, Treap $8.86$, Randomized BST $10.47$.

\textit{Mô tả biểu đồ 3.} Thực hiện $2\,000\,000$ thao tác với giá trị ngẫu
nhiên, gồm $20\%$ chèn, $10\%$ xóa và $60\%$ truy vấn. Thời gian chạy, tính
bằng giây: SBT $3.39$, AVL $4.21$, Treap $5.67$, Randomized BST $6.21$.
