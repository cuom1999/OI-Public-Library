...
này là ghi chú đồng hành theo slide, giữ các ví dụ tìm kiếm, tối ưu quy hoạch
động, lời giải gần tối ưu và các bảng số liệu cốt lõi; những slide lặp lại
đề mục hoặc hiệu ứng trình chiếu được gộp vào phần văn bản tương ứng.
\end{abstract}
