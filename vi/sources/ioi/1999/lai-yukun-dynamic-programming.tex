...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.52\linewidth]{assets/ioi/1999/lai-yukun-dynamic-programming/fig-block-dimensions.png}
  \caption{Ba cạnh \(a,b,c\) của một khối hộp chữ nhật trong bài xếp khối.}
  \label{fig:lai-block-dimensions}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.30\linewidth]{assets/ioi/1999/lai-yukun-dynamic-programming/fig-polygon-example.png}
  \caption{Ví dụ đa giác với \(N=4\), các đỉnh \(-7,4,2,5\) và các cạnh
  \(1,\ldots,4\).}
  \label{fig:lai-polygon-example}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.58\linewidth]{assets/ioi/1999/lai-yukun-dynamic-programming/fig-free-pie-stage.png}
  \caption{Minh họa sân khấu khi chiều cao màn trời là \(4\): bánh rơi từ
  phía trên, người chơi di chuyển ngang để hứng.}
  \label{fig:lai-free-pie-stage}
\end{figure}
