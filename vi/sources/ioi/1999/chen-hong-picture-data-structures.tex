...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.32\linewidth]{assets/ioi/1999/chen-hong-picture-data-structures/fig-01-picture-sample.png}
  \caption{Ví dụ ba hình chữ nhật trong bài \textit{Picture}; chu vi đường bao
  bằng \(30\).}
  \label{fig:chen-hong-picture-sample}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\linewidth]{assets/ioi/1999/chen-hong-picture-data-structures/fig-02-04-covered-elementary.png}
  \caption{Hai kiểu đoạn cạnh bị che phủ và cách chia cạnh \(AB\) thành các
  đoạn nguyên tố \(L_1,L_2,L_3\).}
  \label{fig:chen-hong-covered-elementary}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\linewidth]{assets/ioi/1999/chen-hong-picture-data-structures/fig-05-06-super-segments.png}
  \caption{Cắt mặt phẳng theo các cạnh hình chữ nhật và nhóm các siêu đoạn
  nguyên tố nằm giữa hai đường cắt kề nhau.}
  \label{fig:chen-hong-super-segments}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.46\linewidth,trim={0 0.16in 0 0},clip]{assets/ioi/1999/chen-hong-picture-data-structures/fig-07-cumulative-scan.png}
  \caption{Quét cộng dồn trên một nhóm siêu đoạn nguyên tố: các giá trị
  \(A[i]\) làm thay đổi trạng thái phủ \(\mathit{add}\).}
  \label{fig:chen-hong-cumulative-scan}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.90\linewidth,trim={0 0.18in 0 0},clip]{assets/ioi/1999/chen-hong-picture-data-structures/fig-08-segment-tree.png}
  \caption{Một cây đoạn với các đầu mút \(1,\ldots,10\); các nút màu đỏ biểu
  diễn khoảng \([3,6]\) bằng hợp \([3,5]\cup[5,6]\).}
  \label{fig:chen-hong-segment-tree}
\end{figure}
...
biết số siêu đoạn ngang thuộc đường bao trong nhóm đó. Trong ví dụ này,
nếu trạng thái là \([G,A]\cup[E,C]\), số đoạn liên tục là \(1\), nên số đoạn
đường bao ngang của nhóm là \(2\).

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.56\linewidth]{assets/ioi/1999/chen-hong-picture-data-structures/fig-09-10-sweep-states.png}
  \caption{Hai trạng thái kề nhau của đường quét: khi đoạn che phủ biến mất,
  các đoạn \(DD'\) và \(FF'\) trở thành một phần của đường bao.}
  \label{fig:chen-hong-sweep-states}
\end{figure}
