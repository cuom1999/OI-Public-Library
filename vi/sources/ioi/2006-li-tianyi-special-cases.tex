...
% Source-PDF: IOI中国国家候选队论文/2006/李天翼/李天翼.pdf
...
\sourcepath{IOI Candidate Team Papers/2006/Li Tianyi/Li Tianyi.pdf}
...
\[
  ...
  \right],
\]
với \(k\) là số nguyên dương bất kỳ.\footnote{Trong văn bản trích xuất từ PDF,
...
Bản gốc có hai hình minh họa: khi cạnh \(a_1\) và \(a_n\) chưa giao nhau thì
\(d\) quá lớn; khi \(a_1\) và \(a_n\) cắt chéo thì \(d\) quá nhỏ. Vì miền giá
trị của \(d\) là liên tục, đường kính \(d\) thỏa điều kiện chắc chắn tồn tại
và có thể tìm bằng tìm kiếm nhị phân.
...
\begin{enumerate}
  ...
  \]
  \item Tổng phía sau lớn hơn.\footnote{Bản trích xuất PDF ghi ``tổng phía sau
