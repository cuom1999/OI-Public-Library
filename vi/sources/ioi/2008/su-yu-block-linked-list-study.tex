...
Trong bản Word gốc có hai hình minh họa cho thao tác chèn và xóa. Hình chèn
đánh dấu vị trí ``bắt đầu chèn'', tách khối hiện tại rồi móc các khối mới vào
giữa. Hình xóa đánh dấu đoạn giữa hai đường biên, tách hai đầu đoạn rồi bỏ
các khối nằm trọn trong đoạn đó.
