...
\begin{tikzpicture}[scale=0.82, every node/.style={font=\small}]
  \fill[green!10] (-4,-0.9) rectangle (4,0.9);
  \draw[thick] (-4,-0.9) rectangle (4,0.9);
  \draw[dashed] (-4,0) -- (4,0);
  \fill[blue!70] (0,0) circle (2.2pt) node[above right=2pt] {vòi \(i\)};
  \draw[blue!60, thick] (0,0) circle (2.15);
  \draw[red!70!black, very thick] (-1.95,0) -- (1.95,0);
  \draw[red!70!black, dashed] (-1.95,0) -- (-1.95,-0.9);
  \draw[red!70!black, dashed] (1.95,0) -- (1.95,-0.9);
  \draw[<->] (-4,-1.22) -- (4,-1.22) node[midway, below] {chiều dài bãi cỏ};
  \draw[<->] (4.35,-0.9) -- (4.35,0.9) node[midway, right] {\(w\)};
  \draw[->, blue!70] (0,0) -- (1.52,1.52) node[midway, above left] {\(r_i\)};
  \node[red!70!black] at (0,-0.55)
    {\(\left[x_i-\sqrt{r_i^2-(w/2)^2},\,x_i+\sqrt{r_i^2-(w/2)^2}\right]\)};
\end{tikzpicture}\\[-0.1em]
{\small Hình 4.1: mặt cắt bãi cỏ; vòng tròn tưới của một vòi cắt mép bãi thành
...
\begin{tikzpicture}[scale=0.9, every node/.style={font=\small}]
  ...
  \draw[thick] (-4,-0.45) -- (-3.1,0.25) -- (-2.2,-0.25) -- (-1.35,0.55) --
    (v) -- (1.05,0.25) -- (1.9,0.82) -- (2.8,0.12) -- (3.8,0.55);
  \fill[red!70!black] (v) circle (2.2pt) node[above right=2pt] {đỉnh xét};
  \foreach \x/\name in {-3.2/1,-2.25/2,-1.25/3,-0.2/4,0.85/5,1.9/6,2.9/7} {
    \draw[fill=yellow!70!white] (\x,2.55) circle (3pt);
    \node[above=3pt] at (\x,2.55) {\name};
  }
  \foreach \x in {-1.25,-0.2,0.85,1.9} {
    \draw[blue!65, thin] (v) -- (\x,2.55);
  }
  \draw[gray!60, dashed] (v) -- (-3.2,2.55);
  \draw[gray!60, dashed] (v) -- (2.9,2.55);
  \draw[blue!70!black, very thick] (-1.25,2.88) -- (1.9,2.88);
  \node[blue!70!black, above] at (0.32,2.88) {đoạn bóng đèn nhìn thấy};
  \draw[->, gray!70] (-3.45,3.12) -- (3.15,3.12);
\end{tikzpicture}\\[-0.1em]
{\small Hình 6.1: với một đỉnh của đường núi, các bóng đèn nhìn thấy được tạo
