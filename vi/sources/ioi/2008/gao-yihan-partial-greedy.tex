...
\begin{tikzpicture}[
  >=Latex,
  node distance=1.45cm and 1.8cm,
...
\node[vertex, right=of a] (e) {\(E\)};
\node[vertex, right=of b] (d) {\(D\)};
\node[vertex, below right=of e] (t) {\(T\)};
\draw[->, thick, red!70!black] (s) -- node[above left] {\(1\)} (a);
\draw[->, thick, red!70!black] (a) -- node[above] {\(4\)} (e);
\draw[->, thick, red!70!black] (e) -- node[above right] {\(4\)} (t);
\draw[->, thick, blue!70!black] (s) -- node[below left] {\(2\)} (b);
\draw[->, thick, blue!70!black] (b) -- node[below] {\(2\)} (d);
\draw[->, thick, blue!70!black] (d) -- node[below right] {\(2\)} (t);
\node[red!70!black, align=center] at (2.2,2.15) {tham lam cục bộ:\\\(1+4+4=9\)};
\node[blue!70!black, align=center] at (2.25,-1.55) {tối ưu toàn cục:\\\(2+2+2=6\)};
\end{tikzpicture}
\caption{Phản ví dụ cơ bản cho tham lam thuần túy: cạnh đầu tiên ngắn nhất
không dẫn tới đường đi ngắn nhất toàn cục.}
\end{figure}
