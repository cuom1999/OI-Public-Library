...
Bản dịch đã rà lại cả ba ví dụ trong thân bài: miền modulo nguyên tố của
\textit{Square Root}, biểu diễn tích bằng bộ số mũ trong \textit{Banal
Tickets}, và trạng thái biên phản xạ trong \textit{Shoot Your Gun}. Không còn
tham chiếu hình hoặc chú thích treo. Các chương trình Pascal mẫu được giữ theo
ngoại lệ mã mẫu: không chép nguyên văn, chỉ đưa những chi tiết cần cho phân
tích thuật toán vào phần tương ứng.
