...
\small Các hình nhỏ cho ví dụ Mines: bố trí kim cương và những đường hầm minh
họa.
\end{center}
...
\small Dữ liệu dùng để minh họa hiệu quả của hàm đánh giá.
\end{center}
...
\end{verbatim}
\end{minipage}\\
\small Hai thế Sokoban minh họa.
\end{center}
...
\end{verbatim}
\end{minipage}\\
\small Một số thế deadlock: góc tường, nhóm hộp kẹt nhau, và hộp sát tường
không có đích tương ứng.
\end{center}
...
Biểu đồ thời gian so sánh ba chương trình: A dùng khoảng cách Manhattan gần
nhất, B dùng Manhattan với KM, C thêm sắp xếp con theo đánh giá trên nền B.
Trục hoành là số hiệu dữ liệu, trục tung là thời gian theo mili giây. Đường của
C thấp và ổn định nhất, cho thấy hàm đánh giá vừa dùng để cắt nhánh vừa dùng
để chọn thứ tự mở rộng.
...
Biểu đồ so sánh gồm ba đường: nghiệm tối ưu, nghiệm dùng đánh giá MST và nghiệm
dùng điều chỉnh ngẫu nhiên. Đường MST bám sát nghiệm tối ưu hơn rõ rệt trên hầu
hết các bộ dữ liệu, còn điều chỉnh ngẫu nhiên dao động mạnh hơn do dễ kẹt ở tối
ưu cục bộ.
