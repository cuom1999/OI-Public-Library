...
Mô tả hình 1: một hàng đồng xu được đánh số theo vị trí; trong trạng thái minh
họa, lật đồng thời hai đồng xu ở vị trí 2 và 12 là một thao tác hợp lệ.}}
\end{center}
...
\begin{center}
\fbox{\parbox{0.78\linewidth}{\centering
Mô tả hình 2: trên bàn kích thước \(m=7\), ở trạng thái minh họa người chơi hiện
tại có thể chuyển quân ở ô 2 sang ô 4, quân ở ô 3 sang ô 4, hoặc quân ở ô 6
sang ô 7.}}
\end{center}
...
\section{ACM ICPC 2006 Asia Regional Contest, Beijing}

Phụ lục gốc chỉ ghi tiêu đề này, không kèm thêm nội dung bài toán trong phần
trích xuất được. Nội dung chính của bài \emph{A Funny Stone Game} đã được dịch
ở ví dụ 1.
