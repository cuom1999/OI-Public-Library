...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.36\linewidth]{assets/ioi/2007/gao-yihan-circle-discretization/fig-1-rectangles.png}
  \caption{Ba hình chữ nhật chồng lấn nhau; các tung độ biên chia mặt phẳng
  thành các dải ngang.}
  \label{fig:gao-rectangles}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.58\linewidth]{assets/ioi/2007/gao-yihan-circle-discretization/fig-2-circle-strips.png}
  \caption{Ba hình tròn được cắt bởi các đường ngang qua những tung độ quan
  trọng; mỗi dải chỉ chứa những mảnh đơn giản.}
  \label{fig:gao-circle-strips}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.36\linewidth]{assets/ioi/2007/gao-yihan-circle-discretization/fig-3-flood-fill-grid.png}
  \caption{Lưới điểm phủ lên các đường tròn; các điểm nằm trong hình tròn bị
  loại bỏ rồi flood fill trên phần còn lại.}
  \label{fig:gao-flood-fill-grid}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.42\linewidth]{assets/ioi/2007/gao-yihan-circle-discretization/fig-4-horizontal-chord.png}
  \caption{Giao của một đường ngang với một hình tròn là một đoạn liên tục,
  nên không cần xét từng điểm trên hàng.}
  \label{fig:gao-horizontal-chord}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.58\linewidth]{assets/ioi/2007/gao-yihan-circle-discretization/fig-5-unchanged-region.png}
  \caption{Trong một vùng không có đường tròn nào khác, quan hệ kế thừa giữa
  các đoạn giữ nguyên qua rất nhiều hàng quét.}
  \label{fig:gao-unchanged-region}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.70\linewidth]{assets/ioi/2007/gao-yihan-circle-discretization/fig-6-special-points.png}
  \caption{Các điểm đặc biệt nằm rất gần hai bên của những giao điểm then chốt
  trên mỗi hàng ngang.}
  \label{fig:gao-special-points}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.50\linewidth]{assets/ioi/2007/gao-yihan-circle-discretization/fig-7-uncovered-arc.png}
  \caption{Trên biên của một hình tròn, các hình tròn khác phủ các cung liên
  tục; nếu còn một cung không bị phủ thì bán kính hiện tại chưa đủ.}
  \label{fig:gao-uncovered-arc}
\end{figure}
