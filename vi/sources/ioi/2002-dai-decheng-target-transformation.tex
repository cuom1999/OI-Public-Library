...
Tính đúng đắn khá trực quan. Với một đa giác sáu đỉnh minh họa, nếu ký hiệu
$S_{i,j,k,\ldots}$ là diện tích dương của đa giác tạo bởi các điểm
...
\end{aligned}
\]
Đây chỉ chứng minh cho một cấu hình sáu đỉnh điển hình, nhưng từ đó có thể dễ
...
thẳng và đường thẳng tham chiếu quét ra. Dùng lập luận tương tự cũng chứng
minh được nó đúng, nhưng so với công thức dùng điểm tham chiếu thì kém thuận
tiện hơn: công thức phức tạp hơn, và đường thẳng tham chiếu phải chọn sao cho
không cắt hình, tốt nhất lại là đường nằm ngang. Điều này làm giảm đáng kể
phạm vi áp dụng. Xét về bản chất, hai cách cùng một gốc, và đều có độ phức tạp
$\Oh(N)$ với $N$ là số đỉnh của đa giác.
...
thức $P_i,Q_i$ trở thành dạng quen thuộc:
...
Ví dụ, để xác định điểm $O$ có nằm trong hình $K$ hay không, xét trường hợp
$K$ là một tứ giác $ABCD$ bị khoét một tam giác $AED$. Ta có thể làm như sau:
trước hết kiểm tra $O$ có nằm trong tứ giác $ABCD$ không. Nếu không, hiển
...
Tuy nhiên, thuật toán này có khuyết điểm: có thể dựng phản ví dụ trong đó cách
tách theo dãy đỉnh lồi không xử lý tốt. Vì vậy có một phiên bản cải tiến, dùng
bao lồi để tránh trường hợp ``vượt khung'':
...
$R_2=0$; còn hai ô không chung hàng, không chung cột thì $R_2=1$.
...
hoán vị. Ví dụ, hoán vị $2143$ tương ứng với việc đặt quân tại các ô
$(2,1),(1,2),(4,3),(3,4)$. Nếu trong hoán vị yêu cầu phần tử $i$ không được
đặt ở vị trí $j$, thì ô hàng $i$, cột $j$ của bàn cờ không được đặt quân. Tập
tất cả các ô cấm ấy được gọi là \term{vùng cấm}.
