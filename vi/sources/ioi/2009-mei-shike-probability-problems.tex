...
\begin{tikzpicture}[scale=1.0,line cap=round,>=Latex]
  \draw[->] (-0.2,0) -- (7.0,0);
  \draw[very thick,blue!65] (0,0) -- (3.2,0);
  \draw[thick] (0,0.12) -- (0,-0.12) node[below] {$0$};
  \draw[thick] (3.2,0.12) -- (3.2,-0.12) node[below] {$x$};
  \draw[thick] (6.2,0.12) -- (6.2,-0.12) node[below] {$R_1$};
  \draw[decorate,decoration={brace,amplitude=5pt}] (0,0.45) -- (3.2,0.45)
    node[midway,above=5pt] {$[0,x]$};
  \node[above] at (5.0,0.18) {$[0,R_1]$};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[scale=0.95,line join=round,line cap=round,>=Latex]
  \coordinate (O) at (0,0);
  \coordinate (X) at (4.2,0);
  \coordinate (Y) at (1.2,1.0);
  \coordinate (Z) at (0,3.0);
  \coordinate (XY) at (5.4,1.0);
  \coordinate (XZ) at (4.2,3.0);
  \coordinate (YZ) at (1.2,4.0);
  \coordinate (XYZ) at (5.4,4.0);
  \fill[blue!12] (O) -- (3.2,0) -- (4.2,0.85) -- (1.1,3.0) -- (0,3.0) -- cycle;
  \draw[thick] (O) -- (X) -- (XY) -- (Y) -- cycle;
  \draw[thick] (O) -- (Z) -- (XZ) -- (X);
  \draw[thick] (Z) -- (YZ) -- (XYZ) -- (XZ);
  \draw[thick] (Y) -- (YZ);
  \draw[thick] (XY) -- (XYZ);
  \draw[red!70!black,very thick] (3.2,0) -- (4.2,0.85) -- (1.1,3.0) -- (0,3.0) -- cycle;
  \node[below left] at (O) {$0$};
  \node[below] at (X) {$R_1$};
  \node[left] at (Z) {$R_3$};
  \node[right] at (Y) {$R_2$};
  \node[red!70!black] at (3.4,2.1) {$x_1+x_2+x_3=x$};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[scale=0.85,line cap=round,>=Latex]
  \fill[blue!14] (0,0) -- (4.7,0) -- (0.9,2.8) -- (0,2.8) -- cycle;
  \draw[->] (-0.25,0) -- (6.0,0) node[right] {$x_1$};
  \draw[->] (0,-0.25) -- (0,3.7) node[above] {$x_2$};
  \draw[thick] (0,0) rectangle (5.2,3.0);
  \draw[red!70!black,very thick] (4.7,0) -- (0.9,2.8)
    node[pos=0.55,above right] {$x_1+x_2=x$};
  \node[below] at (5.2,0) {$R_1$};
  \node[left] at (0,3.0) {$R_2$};
  \node[blue!50!black] at (1.35,1.05) {$S\le x$};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.9,line cap=round,line join=round]
  ...
  \coordinate (E) at (4,4);
  \coordinate (F) at (0,4);
  \coordinate (V) at (0.8,3.25);
  \coordinate (A) at (1.75,1.35);
  \coordinate (B) at (2.75,2.25);
  \fill[blue!13] (A) -- (B) -- (4,3.38) -- (4,0) -- (2.42,0) -- cycle;
  \draw[thick] (C) rectangle (E);
  \draw[red!70!black,very thick] (A) -- (B);
  \draw[dashed] (V) -- (A) -- (2.42,0);
  \draw[dashed] (V) -- (B) -- (4,3.38);
  \fill (V) circle (1.5pt) node[above left] {$V$};
  \fill (A) circle (1.5pt) node[below left] {$A$};
  \fill (B) circle (1.5pt) node[above] {$B$};
  \node[blue!50!black] at (3.15,1.15) {$E$};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.9,line cap=round,line join=round]
  ...
  \coordinate (E) at (4,4);
  \coordinate (F) at (0,4);
  \coordinate (A) at (1.45,2.15);
  \draw[thick] (C) rectangle (E);
  \draw[dashed,blue!65] (C) -- (A) -- (2.70,4) node[black,above] {$G$};
  \draw[dashed,blue!65] (D) -- (A) -- (0,3.45) node[black,left] {$H$};
  \draw[dashed,blue!65] (E) -- (A) -- (0,1.00) node[black,left] {$I$};
  \draw[dashed,blue!65] (F) -- (A) -- (3.95,0) node[black,below] {$J$};
  \fill[red!70!black] (A) circle (1.7pt) node[above right] {$A$};
...
\begin{tikzpicture}[scale=0.9,line cap=round,line join=round]
  ...
  \coordinate (E) at (4,4);
  \coordinate (F) at (0,4);
  \coordinate (Q) at (0.55,0);
  \coordinate (R) at (3.55,4);
  \coordinate (A) at (1.45,1.2);
  \coordinate (B) at (2.45,2.55);
  \fill[blue!12] (C) -- (Q) -- (R) -- (F) -- cycle;
  \draw[thick] (C) rectangle (E);
  \draw[red!70!black,very thick] (Q) -- (R);
  \draw[red!70!black,very thick] (A) -- (B);
  \draw[dashed,blue!65] (D) -- (A);
  \draw[dashed,blue!65] (D) -- (B);
  \draw[dashed,blue!65] (E) -- (A);
  \draw[dashed,blue!65] (E) -- (B);
  \fill (A) circle (1.4pt) node[left] {$A$};
  \fill (B) circle (1.4pt) node[left] {$B$};
  \node[below] at (Q) {$Q$};
  \node[above] at (R) {$R$};
  \node[blue!50!black] at (1.1,2.85) {$CQRF$};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[scale=0.9,line cap=round,line join=round,>=Latex]
  \coordinate (A) at (1.55,1.25);
  \coordinate (B) at (2.65,2.45);
  \coordinate (V) at (0.85,3.15);
  \coordinate (Vp) at (1.25,3.45);
  \coordinate (Z) at (0,4.0);
  \coordinate (Zp) at (1.0,4.0);
  \draw[thick] (0,0) rectangle (4,4);
  \fill[blue!16] (Z) -- (A) -- (Zp) -- cycle;
  \draw[red!70!black,very thick] (A) -- (B);
  \draw[dashed] (V) -- (A) -- (Z);
  \draw[dashed] (Vp) -- (A) -- (Zp);
  \draw[->,blue!70!black] (V) -- (Vp);
  \fill (A) circle (1.5pt) node[below] {$A$};
  \fill (B) circle (1.5pt) node[right] {$B$};
  \fill (V) circle (1.5pt) node[left] {$V$};
  \fill (Vp) circle (1.5pt) node[below right] {$V'$};
  \node[above] at (Z) {$Z$};
  \node[above] at (Zp) {$Z'$};
  \node[blue!50!black] at (0.95,3.65) {$\triangle ZAZ'$};
\end{tikzpicture}
\end{center}
