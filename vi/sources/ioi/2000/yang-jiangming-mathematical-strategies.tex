...
Trong hình gốc, quá trình này được biểu diễn bằng sơ đồ N--S. Từ phương trình
cuối cùng có thể trực tiếp tính \(x_n=b'_n/a'_{nn}\), rồi lần lượt thế ngược
để tìm \(x_{n-1},x_{n-2},\ldots,x_1\).
...
Theo phương pháp vừa nêu, dùng sơ đồ N--S của hình gốc để thu được hệ tam
giác. Sau đó chuẩn hóa để các \(A_{ii}\) trong hệ tam giác đều bằng 1:
\[
\begin{aligned}
...
Xét mạng ba dây trong hình gốc, có các cầu lần lượt là \(2/3\), \(1/2\),
\(2/3\). Dùng \(A_{ij}\) biểu thị số trên dây thứ \(j\) sau giai đoạn thứ
\(i\). Ta có:
\[
\begin{array}{c|c|l}
...
cần lấy bằng hai màu xen kẽ; trong hình gốc, ví dụ là dãy
\[
\begin{array}{cccccc}
4&7&2&9&5&6\\
