...
Trong hình gốc, các cạnh chỉ đi từ một tầng sang tầng kế tiếp:
\[
\begin{array}{c}
...
Chia giai đoạn theo các đường chéo nét đứt trong hình gốc: biến giai đoạn
\(k\) biểu thị số bước đã đi, còn biến trạng thái \(s_k\) biểu thị đang ở
điểm nào trên giai đoạn này. Các điểm tương ứng với giai đoạn và trạng thái
đã được đánh dấu bằng \(k,s\) trên bản đồ. Khi đó mô hình thực chất đã chuyển
...
đinh, và có \(n+1\) ô chứa bóng. Khi \(n=5\), bố cục như trong hình gốc. Mỗi
đinh cách các đinh xung quanh một khoảng \(d\); bề rộng của mỗi ô cũng bằng
\(d\). Ngoài ô ngoài cùng bên trái và ngoài cùng bên phải, mỗi ô đều nằm
thẳng dưới khe giữa hai đinh ở hàng dưới cùng.
...
đúng hướng đến đinh tiếp theo mà nó sắp chạm. Hình 2 trong bản gốc là một
đường đi có thể của bóng.
...
3 trong bản gốc là một đường đi có thể của bóng sau khi một số đinh bị nhổ.
