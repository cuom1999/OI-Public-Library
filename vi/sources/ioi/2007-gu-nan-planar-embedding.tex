...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.76\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-01-planar-redraw.png}
  \caption{Ví dụ một đồ thị được vẽ lại sao cho các cạnh không cắt nhau.}
  \label{fig:gu-planar-redraw}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.64\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-02-kuratowski.png}
  \caption{Hai chướng ngại cổ điển cho tính phẳng, \(\Kfive\) và \(\Kthree\).}
  \label{fig:gu-kuratowski}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.86\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-03-cut-merge.png}
  \caption{Tách một khối tại đỉnh khớp, nhúng cạnh mới, có thể đảo một phía
  rồi hợp nhất lại.}
  \label{fig:gu-cut-merge}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.52\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-04-single-edge-cycle.png}
  \caption{Cách xem một cạnh đơn như một chu trình ngoài suy biến.}
  \label{fig:gu-single-edge-cycle}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.48\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-05-outer-active.png}
  \caption{Các đỉnh hình vuông là hoạt động ngoài; tính hoạt động được truyền
  ngược qua các khối con.}
  \label{fig:gu-outer-active}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-06-reversal.png}
  \caption{Phép đảo đổi hướng một khối để đỉnh hoạt động ngoài vẫn nằm trên
  mặt ngoài sau khi ghép.}
  \label{fig:gu-reversal}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.46\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-07-walkup.png}
  \caption{\texttt{walkup} đi đồng thời theo hai hướng và dừng khi gặp gốc
  khối hoặc phần đã thăm.}
  \label{fig:gu-walkup}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.70\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-08-walkdown-cases.png}
  \caption{Sau khi nhúng cạnh tới \(w\), nếu \(w\) vẫn còn liên quan thì tiếp
  tục đi xuống khối con; nếu không, \(w\) trở thành đỉnh dừng.}
  \label{fig:gu-walkdown-cases}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.38\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-09-shortcut-edge.png}
  \caption{Cạnh giả nối tới đỉnh dừng giúp tránh duyệt lại một đoạn mặt ngoài
  không còn cần thiết.}
  \label{fig:gu-shortcut-edge}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.42\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-10-k33-three-outer.png}
  \caption{Ba khối con hoạt động ngoài tạo thành một \(\Kthree\) đồng phôi.}
  \label{fig:gu-k33-three-outer}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.42\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-11-pass-outer-active.png}
  \caption{Đi qua một đỉnh hoạt động ngoài để xử lý khối con của nó không che
  mất đỉnh đó khỏi mặt ngoài.}
  \label{fig:gu-pass-outer-active}
\end{figure}
...
\begin{center}
  \centering
  \includegraphics[width=0.42\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-12-k33-two-stops.png}
  \par\smallskip
  \small Hình 12: Cấu hình có một đỉnh dừng tách các đỉnh liên quan, sinh ra
  một \(\Kthree\) đồng phôi.
\end{center}

\begin{center}
  \centering
  \includegraphics[width=0.40\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-13-k5-two-outer.png}
  \par\smallskip
  \small Hình 13: Cấu hình có hai đỉnh vừa liên quan vừa hoạt động ngoài, sinh
  ra một \(\Kfive\) đồng phôi.
\end{center}
...
\begin{center}
  \centering
  \includegraphics[width=0.40\linewidth]{assets/ioi/2007/gu-nan-planar-embedding/fig-14-blocked-related.png}
  \par\smallskip
