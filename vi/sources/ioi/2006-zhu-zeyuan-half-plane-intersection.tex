...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.86\linewidth]{assets/ioi/2006/zhu-zeyuan-half-plane/fig-i-hpi-examples.png}
  \caption{Hai ví dụ HPI trong bản gốc: (a) miền giao bị chặn; (b) miền giao
  không bị chặn trước khi thêm một khung chữ nhật đủ lớn.}
  \label{fig:zhu-hpi-examples}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.74\linewidth]{assets/ioi/2006/zhu-zeyuan-half-plane/fig-ii-cpi-sweep.png}
  \caption{Minh họa quét CPI: đoạn đỏ trên đường quét là phần đang nằm trong
  cả hai đa giác, còn các điểm tròn là những sự kiện \(x\) kế tiếp có thể xảy
  ra.}
  \label{fig:zhu-cpi-sweep}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\linewidth]{assets/ioi/2006/zhu-zeyuan-half-plane/fig-iii-polar-angle.png}
  \caption{Định nghĩa góc cực của nửa mặt phẳng theo hướng đường biên được
  chọn.}
  \label{fig:zhu-polar-angle}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.70\linewidth]{assets/ioi/2006/zhu-zeyuan-half-plane/fig-iv-same-angle.png}
  \caption{Khi nhiều nửa mặt phẳng có cùng góc cực, chỉ cần giữ nửa mặt phẳng
  chặt nhất; các nửa mặt phẳng còn lại không thể tạo cạnh mới của miền giao.}
  \label{fig:zhu-same-angle}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{assets/ioi/2006/zhu-zeyuan-half-plane/fig-v-stack-step.png}
  \caption{Ví dụ cho bước 3: khi thêm một nửa mặt phẳng mới, các giao điểm cũ
  nằm bên trái giao điểm mới sẽ bị loại; phần nét đứt là đoạn biên không còn
  hợp lệ.}
  \label{fig:zhu-stack-step}
\end{figure}

Hình~\ref{fig:zhu-stack-step} cho thấy trực giác của thao tác này: khi thêm
một nửa mặt phẳng có góc cực lớn hơn, các giao điểm cũ nằm bên trái giao điểm
mới không còn tạo thành phần biên hợp lệ của nửa đa giác đang xây dựng, nên
các nửa mặt phẳng tương ứng bị pop khỏi ngăn xếp.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{assets/ioi/2006/zhu-zeyuan-half-plane/fig-vi-deque-step.png}
  \caption{Ví dụ cho bước 4: dùng các con trỏ \(p_1,p_2,p_3,p_4\) ở hai đầu
  của hai vỏ để lần lượt xóa giao điểm ngoài cùng chắc chắn không khả thi.}
  \label{fig:zhu-deque-step}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.42\linewidth]{assets/ioi/2006/zhu-zeyuan-half-plane/fig-vii-zero-intersections.png}
  \caption{Số giao điểm của một vỏ riêng lẻ có thể giảm xuống \(0\), dù miền
  khả thi tổng thể vẫn chưa rỗng.}
  \label{fig:zhu-zero-intersections}
\end{figure}
