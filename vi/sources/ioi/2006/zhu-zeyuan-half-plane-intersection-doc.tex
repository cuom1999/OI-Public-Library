...
% Source-File: IOI中国国家候选队论文/2006/朱泽园/朱泽园.doc
...
\sourcepath{IOI China candidate team papers / 2006 / Zhu Zeyuan.doc}
...
\begin{figure}[htbp]
  ...
  \caption{Bước S\&I với một vỏ: khi thêm một nửa mặt phẳng mới, các giao điểm
  cũ nằm sai phía bị loại bằng thao tác pop trên ngăn xếp.}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Gộp hai vỏ bằng cách thử loại các giao điểm ngoài cùng trong cấu
  trúc hàng đợi hai đầu.}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.42\linewidth]{assets/ioi/2006/zhu-zeyuan-half-plane/fig-vii-zero-intersections.png}
  \caption{Một vỏ riêng có thể tạm thời không còn giao điểm, nhưng giao của
  toàn bộ hệ vẫn có thể chưa rỗng; vì vậy không được kết luận quá sớm.}
\end{figure}
