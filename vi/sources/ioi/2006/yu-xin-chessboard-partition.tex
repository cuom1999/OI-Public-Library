...
1 hoặc module 2 còn lại được dùng để loại bỏ thêm quân như trong hình minh họa
của bản gốc. Trường hợp \(p=3,q=4\) chính là ví dụ đã nêu, còn các trường hợp
đối xứng nhận được bằng cách xoay bàn cờ \(90^\circ\).
