...
Bản DOC gốc có một số sơ đồ cổng Bornholm--Gotland và sơ đồ chia hai phần
\(S_A,S_B\). Các hình không được trích xuất ổn định từ tệp Word cũ; nội dung
của chúng đã được diễn giải trong phần tương ứng. Phụ lục mã nguồn cho các ví
dụ không được chép lại vì đây là các chương trình mẫu dài, không phải nội dung
lý thuyết chính.
