...
% Source-PDF: IOI中国国家候选队论文/2005/黄源河/黄源河.pdf
...
\((\operatorname{key},\operatorname{dist})\). Một ví dụ tương ứng là:
\[
\begin{array}{c}
  (1,2)\\[0.2em]
  \begin{array}{cc}
...
\end{array}
\]
Trong ví dụ này, các lá có khoảng cách \(0\), còn các nút nằm sâu hơn vẫn thỏa
