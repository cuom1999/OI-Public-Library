...
list, cùng các hình minh họa thao tác tìm kiếm, chèn và xóa. Trong bản chuyển
sang LaTeX này, các hình Word không được trích xuất đáng tin cậy nên đã được
diễn giải bằng mô tả cấu trúc và quy trình thao tác ở các phần trên. Mã Pascal
không phải nội dung cần dịch, nên không được chép lại đầy đủ.
