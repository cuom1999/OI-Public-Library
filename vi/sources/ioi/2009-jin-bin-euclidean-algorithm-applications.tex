...
Khi hai vector $a$ và $b$ gần như cùng hướng, lưới sinh bởi chúng trở nên rất
dẹt. Khi đó bài toán có thể nhìn như việc tìm điểm lưới khác $O$ có khoảng
cách tới $O$ nhỏ nhất; góc giữa hai vector càng nhỏ thì trường hợp càng
``không tầm thường''.
...
\paragraph{Diễn giải hình học.}
Hãy tưởng tượng một bó tia đi xuống từ các điểm trên đường thẳng, cắt các
đường ngang $y=km$. Khi đó ta có thể chuyển từ ``đếm giao điểm trên các tia
dọc'' sang ``đếm số điểm phía trên từng đường ngang'', với hai mức độ cao
$\mathit{topY}$ và $\mathit{nowY}$.
