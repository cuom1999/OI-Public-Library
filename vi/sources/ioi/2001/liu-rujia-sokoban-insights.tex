...
\caption{Màn chuẩn số 1, kèm chuỗi đẩy thùng được in ngay dưới
bản đồ. Tọa độ cột/hàng trong sơ đồ được giữ để các ví dụ sau tham chiếu
được thống nhất.}
\end{figure}
...
\caption{Ví dụ bế tắc điển hình: một thùng bị đẩy vào góc tường
