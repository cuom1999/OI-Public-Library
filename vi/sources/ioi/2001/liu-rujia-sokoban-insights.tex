...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\linewidth]{assets/ioi/2001/liu-rujia-sokoban/standard-level-1-solution.png}
\caption{Màn chuẩn số 1 trong nguồn, kèm chuỗi đẩy thùng được in ngay dưới
bản đồ. Tọa độ cột/hàng được giữ theo hình gốc để các ví dụ sau tham chiếu
được thống nhất.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.52\linewidth]{assets/ioi/2001/liu-rujia-sokoban/deadlock-example.png}
\caption{Ví dụ bế tắc điển hình trong nguồn: một thùng bị đẩy vào góc tường
và không còn có thể đưa ra ngoài bằng các thao tác hợp lệ.}
\end{figure}
