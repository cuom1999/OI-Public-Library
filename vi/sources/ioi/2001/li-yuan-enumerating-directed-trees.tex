...
hiện bằng cách lấy đi một đỉnh con của nó; trong các sơ đồ dưới đây, cây con
bị làm nhỏ được đánh dấu bằng khung nét đứt.
...
con còn lại đó làm đỉnh bị xóa. Trong sơ đồ dưới đây, khi đi ngược từ \(A\)
qua \(B\) đến \(C\), vì \(C\) còn một con \(E\), thuật toán đổi mục tiêu từ
\(A\) sang \(E\).
...
\begin{tikzpicture}[scale=0.72]
  ...
  \node[align=left,anchor=west,text width=6.6cm] at (2.0,2.5)
