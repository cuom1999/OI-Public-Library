...
\begin{tikzpicture}[>=Stealth, scale=0.9,
  state/.style={draw,align=center,minimum width=0.95cm,minimum height=0.38cm,
    inner sep=1.5pt,font=\scriptsize},
  edge/.style={->}]
  \begin{scope}[xshift=-3.1cm]
    \node[font=\small\bfseries] at (0,0.55) {Đối tượng là xe};
    \node[state] (a0) at (0,0) {\(0?\)};
    \node[state] (a1) at (-1.15,-0.85) {\(03\) loại};
    \node[state] (a2) at (1.0,-0.85) {\(0?,3?\)};
    \node[state] (a3) at (-1.55,-1.7) {\(05\) loại};
    \node[state] (a4) at (0,-1.7) {\(35\) loại};
    \node[state] (a5) at (1.55,-1.7) {\(0?,3?,5?\)};
    \node[state] (a6) at (-0.25,-2.65) {\(013\) loại};
    \node[state] (a7) at (1.35,-2.65) {\(5,13\)};
    \node[state] (a8) at (2.8,-2.65) {\(13?\)};
    \foreach \u/\v in {a0/a1,a0/a2,a2/a3,a2/a4,a2/a5,a5/a6,a5/a7,a5/a8}
      \draw[edge] (\u) -- (\v);
    \node[align=center,font=\scriptsize] at (0.45,-3.35)
      {càng xuống sâu\\số nhánh càng tăng};
  \end{scope}

  \begin{scope}[xshift=3.25cm]
    \node[font=\small\bfseries] at (0,0.55) {Đối tượng là tuyến};
    \node[state] (b0) at (0,0) {\(0?\)};
    \node[state] (b1) at (-1.45,-0.85) {\(03\) loại};
    \node[state] (b2) at (0,-0.85) {\(014,3?\)};
    \node[state] (b3) at (1.45,-0.85) {\(025,3?\)};
    \node[state] (b4) at (-1.1,-1.8) {\(\cdots35\) loại};
    \node[state] (b5) at (0.45,-1.8) {\(\cdots13\) loại};
    \node[state] (b6) at (1.85,-1.8) {\(\cdots14,5?\)};
    \node at (1.2,-2.55) {\(\cdots\)};
    \foreach \u/\v in {b0/b1,b0/b2,b0/b3,b2/b4,b2/b5,b2/b6}
      \draw[edge] (\u) -- (\v);
    \node[align=center,font=\scriptsize] at (0.35,-3.35)
      {càng xuống sâu\\số nhánh càng giảm};
  \end{scope}
\end{tikzpicture}\\
\small Hai cây tìm kiếm trong ví dụ nguồn: chọn xe làm đối tượng tạo cây
ngày càng rậm; chọn tuyến làm đối tượng tạo cây hẹp dần.
\end{center}
...
\begin{center}
\begin{tikzpicture}[>=Stealth, x=0.72cm,y=0.65cm,
  every node/.style={font=\small}]
  \begin{scope}
    \draw[->] (0,0) -- (4.4,0);
    \draw[->] (0,0) -- (0,3.4);
    \draw[thick] (0.35,3.1) .. controls (0.8,1.0) and (1.5,0.45) ..
      (2.05,0.45) .. controls (2.8,0.48) and (3.45,1.5) .. (3.85,3.15);
    \draw[thick] (0.2,0.75) .. controls (1.2,0.85) and (2.2,0.65) ..
      (3.9,0.62);
    \node[align=center] at (2.75,2.55) {hệ số thao tác\\mỗi nút};
    \node[align=center] at (2.75,1.0) {số nút\\sau cắt tỉa};
  \end{scope}
  \draw[thick,->] (4.85,1.65) -- (5.85,1.65);
  \begin{scope}[xshift=6.35cm]
    \draw[->] (0,0) -- (4.4,0);
    \draw[->] (0,0) -- (0,3.4);
    \draw[thick] (0.55,3.05) .. controls (1.05,1.0) and (1.65,0.42) ..
      (2.25,0.42) .. controls (2.95,0.42) and (3.45,1.35) .. (3.85,3.05);
    \fill (2.25,0.42) circle (2pt);
    \draw (2.25,0.42) circle (5pt);
    \node[draw,fill=white,inner sep=2pt] at (2.25,1.05) {điểm cân bằng};
    \node[align=center] at (3.25,1.95) {thời gian\\DFS};
  \end{scope}
\end{tikzpicture}\\
\small Quan hệ giữa mức cắt tỉa và thời gian DFS: cắt tỉa nhiều làm giảm số
nút, nhưng thường làm tăng chi phí xử lý mỗi nút; thời gian tìm kiếm tốt nhất
nằm gần điểm cân bằng.
\end{center}
