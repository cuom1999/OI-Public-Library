...
\paragraph{Hình 1.}
Hình gốc là một đồ thị phân lớp gồm năm giai đoạn:
\[
  \{1\},\quad \{2,3\},\quad \{4,5,6\},\quad \{7,8,9\},\quad \{10\}.
\]
Các cạnh chỉ nối giữa hai giai đoạn kề nhau. Một vài cạnh được dùng trực tiếp
trong phân tích là $1\to2$ có trọng số $4$, $1\to3$ có trọng số $2$,
$2\to5$ có trọng số $5$, $3\to5$ có trọng số $4$, $3\to6$ có trọng số $3$,
$5\to8$ có trọng số $5$, $6\to8$ có trọng số $5$; các cạnh từ lớp thứ tư về
$10$ có các trọng số như trong hình gốc.
...
\paragraph{Hình 2.}
Hình gốc minh họa một đường từ $A$ đến $C$ được tách thành đoạn $I$ từ $A$ đến
$B$ và đoạn $J$ từ $B$ đến $C$, đồng thời vẽ một đường thay thế $J'$ từ $B$ đến
$C$.
...
\paragraph{Hình 3.}
Hình gốc là một đồ thị có trọng số trên các đỉnh $A,\ldots,J$. Những cạnh
đọc được rõ và được dùng trong phân tích gồm
\[
  A B=3,\quad A D=4,\quad A C=2,\quad B D=5,\quad B E=7,
\]
\[
  C D=1,\quad C F=1,\quad D E=2,\quad D G=5,\quad D F=2,
\]
cùng các cạnh phía phải nối tới $H,I,J$ như $E H=4$, $EJ=3$, $GJ=6$,
$F G=5$, $G I=7$, $I J=2$. Hình dùng để minh họa một đồ thị không phân lớp rõ
ràng, trong đó đường trực tiếp $A-D$ có chi phí $4$, còn đường $A-C-D$ có chi
phí $3$.
