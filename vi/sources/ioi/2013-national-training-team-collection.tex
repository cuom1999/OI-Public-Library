...
dịch này chuyển ngữ thông tin đầu sách, mục lục và hai bài đầu tiên:
\emph{Kế hoạch lên đỉnh}, của Peng Tianyi, và \emph{Lấy số trên lưới}, của
Wang Kangning. Trạng thái hiện tại: hai bài đầu đã được dịch; các bài còn lại
...
dùng các trang in \(9\)--\(16\), tức trang vật lý \(13\)--\(20\). Trang vật lý
\(21\) là trang in \(17\) và bắt đầu bài \emph{Two strings}, nên không được
đưa vào phần dịch dưới đây.
