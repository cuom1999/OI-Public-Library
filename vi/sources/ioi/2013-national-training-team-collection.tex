...
dịch này chuyển ngữ thông tin đầu sách, mục lục và năm bài đầu tiên:
...
tưởng chia khối trong một lớp bài xử lý dữ liệu}, của Luo Jianqiao. Trạng
thái hiện tại: năm bài đầu đã được dịch; các bài còn lại mới có mục lục. Lớp
văn bản của phần thân bị lỗi ánh xạ phông chữ, nên phần bài viết được đối
chiếu từ OCR trang render và các công thức, ví dụ còn đọc được trong lớp văn
bản.
\end{abstract}
