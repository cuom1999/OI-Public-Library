...
\begin{verbatim}
thu tuc giao cac nua mat phang
Du lieu vao:
  n nua mat phang H1,H2,...,Hn, tuong ung voi cac bat dang thuc
  ai*x+bi*y+ci >= 0, i=1,2,3,...,n
Du lieu ra:
  H1 giao H2 giao ... giao Hn

  Khoi tao mien A la toan bo mat phang.
  Voi i = 1,2,...,n:
    Cat A boi duong thang ai*x+bi*y+ci = 0.
    Giu lai phan thoa ai*x+bi*y+ci >= 0.
  Xuat A.
\end{verbatim}
...
\begin{verbatim}
Thu tuc giao nua mat phang (chia de tri)
Du lieu vao:
  n nua mat phang H1,H2,...,Hn, tuong ung voi cac bat dang thuc
  ai*x+bi*y+ci >= 0, i=1,2,3,...,n
Du lieu ra:
  ...
  Chia H1,...,Hn thanh hai tap co kich thuoc gan bang nhau.
  De quy tinh mien giao trong tung bai toan con.
  Hop nhat hai mien da giac loi de thu duoc
  H1 giao H2 giao ... giao Hn.
\end{verbatim}
...
\begin{verbatim}
thu tuc giao hai da giac loi
Du lieu vao:
  hai mien da giac loi A va B
Du lieu ra:
  C = A giao B

1. Phan loai cac dinh cua hai da giac theo toa do x, thu duoc day
   x_i, i=1,...,p.
2. Khoi tao C la mien rong.
3. Xu ly {x_1}.
4. Lan luot xu ly cac mien (x_i, x_{i+1}], i=1,...,p-1.
   4.1 Tinh cac hinh thang, co the suy bien, cat ra tu hai da giac
       trong mien nay. Goi chung la ABCD va A'B'C'D'.
   4.2 Tinh cac giao diem
       AB giao A'B', AB giao C'D', va CD giao A'B'.
       Sap xep cac diem ton tai theo toa do x, xoa diem trung, roi
       noi chung vao bien tren cua C. Bien duoi cua C tinh tuong tu.
   4.3 Tinh bien phai cua mien nay:
       EF = BC giao B'C'. Noi E vao bien tren va F vao bien duoi
       cua C.
5. Xuat C.
\end{verbatim}
...
thu tuc giao cac nua mat phang
Du lieu vao:
  n nua mat phang H1,H2,...,Hn
Du lieu ra:
  H1 giao H2 giao ... giao Hn

  Khoi tao mien A la toan bo mat phang.
  Lan luot cat A boi cac duong thang ai*x+bi*y+ci=0,
  i=1,2,...,n, va giu phan thoa ai*x+bi*y+ci>=0.
  Xuat A.

Do phuc tap O(n*n); day la thuat toan truc tuyen.
\end{verbatim}
...
1. Phan loai toa do x cua cac dinh hai da giac, thu duoc day
   x_i, i=1,...,p.
2. Khoi tao C la mien rong.
3. Xu ly {x_1}.
4. Lan luot xu ly cac mien (x_i,x_{i+1}], i=1,...,p-1.
...
4. Lan luot xu ly cac mien (x_i,x_{i+1}], i=1,...,p-1.
   4.1 Tinh cac hinh thang, co the suy bien, cat ra tu hai da giac
       trong mien nay: ABCD va A'B'C'D'.
   4.2 Tinh AB giao A'B', AB giao C'D', va CD giao A'B'.
       Sap xep cac diem ton tai theo toa do x, xoa diem trung,
       roi noi chung vao bien tren cua C.
   4.3 Tinh bien duoi cua C theo cach tuong tu.
   4.4 Tinh bien phai cua mien nay bang giao doan thang:
       EF = BC giao B'C'. Noi E va F lan luot vao bien tren
       va bien duoi cua C.
\end{verbatim}
